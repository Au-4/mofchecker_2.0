...
from .checks.utils.get_indices import get_c_indices, get_h_indices, get_metal_indices, get_n_indices, get_o_indices,get_metal_indices
...
#        return self.checks["metal_oxi"]
    ...
    def metal_number(self) -> int:
        ...
        return len(get_metal_indices(self.structure))
    @property
